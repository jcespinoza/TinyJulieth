...
LEXER_SRC=lexer.cpp
TESTS=Arithmetic Arrays Bitwise BubbleSort comments Factorial functions helloworld Relational printFormat recursion several while_break while if  QuickSort
