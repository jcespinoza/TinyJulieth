...
LEXER_SRC=lexer.cpp
TESTS=Arithmetic Arrays Bitwise BubbleSort comments Factorial functions helloworld Relational printFormat while_break recursion several  while if  QuickSort
