...
root: opt_newlines gstatement_list { document = new JuliaDocument(); document->statements = $2; document->Process(); document->PrintDoc(); YYTRACE("PASSED: File with Statements\n"); }
